...
tresult PLUGIN_API PluginController::initialize(FUnknown* context)
{
    ...
    parameters.addParameter(STR16("Alpha"), nullptr, 0, 0.5, ParameterInfo::kCanAutomate, kParamAlpha);
    parameters.addParameter(STR16("Beta"), nullptr, 0, 0.5, ParameterInfo::kCanAutomate, kParamBeta);
